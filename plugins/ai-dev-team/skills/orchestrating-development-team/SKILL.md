...
- No specialist stage ran twice by two different executors (inline skill + delegated agent) without a stated, specific reason — cross-checking a delegate's findings is not a second run of the stage.
